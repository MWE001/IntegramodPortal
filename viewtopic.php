 ...
 *
 *   $Id: viewtopic.php 8479 2008-03-29 00:22:48Z naderman $
 *
 *
 ***************************************************************************/
...
$reply_l_img = ( $forum_topic_data['forum_status'] == FORUM_LOCKED || $forum_topic_data['topic_status'] == TOPIC_LOCKED ) ? $images['reply_locked'] : $images['reply_new'];
$reply_alt = ( $forum_topic_data['forum_status'] == FORUM_LOCKED || $forum_topic_data['topic_status'] == TOPIC_LOCKED ) ? $lang['Topic_locked'] : $lang['Reply_to_topic'];
$post_img = ( $forum_topic_data['forum_status'] == FORUM_LOCKED ) ? $images['post_locked'] : $images['post_new'];
$post_l_img = ( $forum_topic_data['forum_status'] == FORUM_LOCKED ) ? $images['post_locked'] : $images['post_new'];
...
$template->assign_vars(array(
	...
	'POST_IMG' => $post_img,
	'POST_L_IMG' => $post_l_img,
	'REPLY_IMG' => $reply_img,
	'REPLY_L_IMG' => $reply_l_img,
...
for($i = 0; $i < $total_posts; $i++)
{
	...
	if ( $poster_id != ANONYMOUS )
	{
		...
		$profile_l_img = '<td><a class="icon_user_profile" href="' . $temp_url . '"><span class="ireg">' . $lang['Profile'] . '</span></a></td>';

		$profile = '<a href="' . $temp_url . '">' . $lang['Read_profile'] . '</a>';

		$temp_url = append_sid("privmsg.$phpEx?mode=post&amp;" . POST_USERS_URL . "=$poster_id");
		$pm_img = '<a href="' . $temp_url . '"><img src="' . $images['icon_pm'] . '" alt="' . $lang['Send_private_message'] . '" title="' . $lang['Send_private_message'] . '" border="0" /></a>';
		$pm_l_img = '<td><a class="icon_user_pm" href="' . $temp_url . '" title="' . $lang['Send_private_message'] . '"><span class="ireg">' . $lang['PM'] . '</span></a></td>';
		...
		if ( !empty($postrow[$i]['user_viewemail']) || $is_auth['auth_mod'] )
		{
			...
			$email_l_img = '<td><a class="icon_user_email" href="' . $email_uri . '" title="' . $lang['Send_email'] . '"><span class="ireg">' . $lang['Email'] . '</span></a></td>';
		...
		$www_l_img = ( $postrow[$i]['user_website'] ) ? '<td><a class="icon_user_website" href="' . $postrow[$i]['user_website'] . '" target="_userwww" title="' . $lang['Visit_website'] . '"><span class="ireg">' . $lang['WWW'] . '</span></a></td>' : '';
		...
		if ( !empty($postrow[$i]['user_icq']) )
		{
			...
			$icq_l_img = '<a class="icon_user_icq" href="http://wwp.icq.com/scripts/search.dll?to=' . $postrow[$i]['user_icq'] . '" title="' . $lang['ICQ'] . '"><span class="ireg">' . $lang['ICQ_S'] . '</span></a>';
		...
		$aim_l_img = ( $postrow[$i]['user_aim'] ) ? '<td><a class="icon_user_aim" href="aim:goim?screenname=' . $postrow[$i]['user_aim'] . '&amp;message=Hello+Are+you+there?" title="' . $lang['AIM'] . '"><span class="ireg">' . $lang['AIM_S'] . '</span></a></td>' : '';
		...
		$msn_l_img = ( $postrow[$i]['user_msnm'] ) ? '<td class=""><a class="icon_user_msnm" href="' . $temp_url . '" title="' . $lang['MSNM'] . '"><span class="ireg">' . $lang['MSNM_S'] . '</span></a></td>' : '';

		$msn = ( $postrow[$i]['user_msnm'] ) ? '<a href="' . $temp_url . '">' . $lang['MSNM'] . '</a>' : '';

		$yim_img = ( $postrow[$i]['user_yim'] ) ? '<a href="http://edit.yahoo.com/config/send_webmesg?.target=' . $postrow[$i]['user_yim'] . '&amp;.src=pg"><img src="' . $images['icon_yim'] . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
		$yim_l_img = ( $postrow[$i]['user_yim'] ) ? '<td><a class="icon_user_yim" href="http://edit.yahoo.com/config/send_webmesg?.target=' . $postrow[$i]['user_yim'] . '&amp;.src=pg" title="' . $lang['YIM'] . '"><span class="ireg">' . $lang['YIM_S'] . '</span></a></td>' : '';
	...
	$quote_l_img = '<a class="icon_post_quote" href="' . $temp_url . '" title="' . $lang['Reply_with_quote'] . '"><span class="ireg">' . $lang['Quote'] . '</span></a>';
	...
	$search_l_img = '<a class="icon_post_search" href="' . $temp_url . '" title="' . sprintf($lang['Search_user_posts'], $postrow[$i]['username']) . '"><span class="ireg">' . $lang['Search'] . '</span></a>';
	...
	if ( ( $userdata['user_id'] == $poster_id && $is_auth['auth_edit'] ) || $is_auth['auth_mod'] )
	{
		...
		$edit_l_img = '<a class="icon_post_edit" href="' . $temp_url . '" title="' . $lang['Edit_delete_post'] . '"><span class="ireg">' . $lang['Edit'] . '</span></a>';
	...
	if ( $is_auth['auth_mod'] )
	{
		...
		$ip_l_img = '<a class="icon_user_ip" href="' . $temp_url . '" title="' . $lang['View_IP'] . '"><span class="ireg">' . $lang['IP'] . '</span></a>';
		...
		$delpost_l_img = '<a class="icon_post_delete" href="' . $temp_url . '" title="' . $lang['Delete_post'] . '"><span class="ireg">' . $lang['Delete_s'] . '</span></a>';
	...
	$template->assign_block_vars('postrow', array(
		...
		'YIM' => $yim,
		'EDIT_IMG' => $edit_img,
		'EDIT_L_IMG' => $edit_l_img,
		'EDIT' => $edit,
		'QUOTE_IMG' => $quote_img,
		'QUOTE_L_IMG' => $quote_l_img,
		'QUOTE' => $quote,
		'IP_IMG' => $ip_img,
		'IP_L_IMG' => $ip_l_img,
		'IP' => $ip,
		'DELETE_IMG' => $delpost_img,
		'DELETE_L_IMG' => $delpost_l_img,
		'DELETE' => $delpost,
