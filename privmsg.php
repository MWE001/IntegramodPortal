 ...
 *
 *   $Id: privmsg.php 8479 2008-03-29 00:22:48Z naderman $
 *
 *
 ***************************************************************************/
...
else if ( $mode == 'read' )
{
	...
	$post_icons = array(
		...
		'post_l_img' => '<a class="button_new pm" href="' . $post_urls['post'] . '" title="' . $lang['Post_new_pm'] . '"><div class="reg">' . $lang['New'] . '<span class="golden">' . $lang['Post'] . '</span></div></a>',
		...
		'reply_l_img' => '<a class="button_reply pm" href="' . $post_urls['reply'] . '"><div class="reg">' . $lang['Post'] . '<span class="golden">' . $lang['Reply'] . '</span></div></a>',
		...
		'quote_l_img' => '<a class="icon_post_quote" href="' . $post_urls['quote'] . '" title="' . $lang['Post_quote_pm'] . '"><span class="reg">' . $lang['Quote'] . '</span></a>',
		...
		'edit_l_img' => '<a class="icon_post_edit" href="' . $post_urls['edit'] . '" title="' . $lang['Edit_pm'] . '"><span class="reg">' . $lang['Edit'] . '</span></a>',
	...
	if ( $folder == 'inbox' )
	{
		...
		$post_l_img = $post_icons['post_l_img'];
		$reply_img = $post_icons['reply_img'];
		$reply_l_img = $post_icons['reply_l_img'];
		$quote_img = $post_icons['quote_img'];
		$quote_l_img = $post_icons['quote_l_img'];
		$edit_img = '';
		$edit_l_img = '';
	...
	else if ( $folder == 'outbox' )
	{
		...
		$edit_l_img = $post_icons['edit_l_img'];
		$post = $post_icons['post'];
		$reply = '';
		$quote = '';
	...
	$template->assign_vars(array(
		...
		'POST_PM_L_IMG' => $post_l_img,
		'REPLY_PM_IMG' => $reply_img, 
		'REPLY_PM_L_IMG' => $reply_l_img, 
		'EDIT_PM_IMG' => $edit_img, 
		'EDIT_PM_L_IMG' => $edit_l_img,
		'QUOTE_PM_IMG' => $quote_img, 
		'QUOTE_PM_L_IMG' => $quote_l_img,
		'POST_PM' => $post, 
		'REPLY_PM' => $reply, 
		'EDIT_PM' => $edit, 
		'QUOTE_PM' => $quote, 
	...
	$profile_l_img = '<a class="icon_user_profile" href="' . $temp_url . '" title="' . $lang['Read_profile'] . '"><span class="ireg">' . $lang['Profile'] . '</span></a></a>';
	$profile = '<a href="' . $temp_url . '">' . $lang['Read_profile'] . '</a>';

	$temp_url = append_sid("privmsg.$phpEx?mode=post&amp;" . POST_USERS_URL . "=$user_id_from");
	$pm_img = '<a href="' . $temp_url . '"><img src="' . $images['icon_pm'] . '" alt="' . $lang['Send_private_message'] . '" title="' . $lang['Send_private_message'] . '" border="0" /></a>';
	$pm_l_img = '<a class="icon_user_pm" href="' . $temp_url . '" title="' . $lang['Send_private_message'] . '"><span class="ireg">' . $lang['PM'] . '</span></a>';
	...
	if ( !empty($privmsg['user_viewemail']) || $userdata['user_level'] == ADMIN )
	{
		...
		$email_l_img = '<a class="icon_user_email" href="' . $email_uri . '" title="' . $lang['Send_email'] . '"><span class="ireg">' . $lang['Email'] . '</span></a>';
	...
	$www_l_img = ( $privmsg['user_website'] ) ? '<a class="icon_user_website" href="' . $privmsg['user_website'] . '" target="_userwww" title="' . $lang['Visit_website'] . '"><span class="ireg">' . $lang['WWW'] . '</span></a>' : '&nbsp;';
	...
	if ( !empty($privmsg['user_icq']) )
	{
		...
		$icq_l_img = '<a class="icon_user_icq" href="http://wwp.icq.com/scripts/search.dll?to=' . $privmsg['user_icq'] . '" title="' . $lang['ICQ'] . '"><span class="ireg">' . $lang['ICQ_S'] . '</span></a>';
	...
	$aim_l_img = ( $privmsg['user_aim'] ) ? '<a class="icon_user_aim" href="aim:goim?screenname=' . $privmsg['user_aim'] . '&amp;message=Hello+Are+you+there?" title="' . $lang['AIM'] . '"><span class="ireg">' . $lang['AIM_S'] . '</span></a>' : '&nbsp;';
	...
	$msn_l_img = ( $privmsg['user_msnm'] ) ? '<a class="icon_user_msnm" href="' . $temp_url . '" title="' . $lang['MSNM'] . '"><span class="ireg">' . $lang['MSNM_S'] . '</span></a>' : '&nbsp;';
	...
	$yim_l_img = ( $privmsg['user_yim'] ) ? '<a class="icon_user_yim" href="http://edit.yahoo.com/config/send_webmesg?.target=' . $privmsg['user_yim'] . '&amp;.src=pg" title="' . $lang['YIM'] . '"><span class="ireg">' . $lang['YIM_S'] . '</span></a>' : '';
	...
	$search_l_img = '<a class="icon_post_search" href="' . $temp_url . '" title="' . sprintf($lang['Search_user_posts'], $privmsg['username']) . '"><span class="ireg">' . $lang['Search'] . '</span></a>';
	...
	$template->assign_vars(array(
		...
		'PROFILE_L_IMG' => $profile_l_img,
		'PROFILE' => $profile, 
		'SEARCH_IMG' => $search_img,
		'SEARCH_L_IMG' => $search_l_img,
		'SEARCH' => $search,
		'EMAIL_IMG' => $email_img,
		'EMAIL_L_IMG' => $email_l_img,
		'EMAIL' => $email,
		'WWW_IMG' => $www_img,
		'WWW_L_IMG' => $www_l_img,
		'WWW' => $www,
...
// New message
//
$post_new_mesg_url = '<a class="button_new pm" href="' . append_sid("privmsg.$phpEx?mode=post") . '" title="' . $lang['Post_new_pm'] . '"><div class="reg">' . $lang['New'] . '<span class="golden">' . $lang['Post'] . '</span></div></a>';
...
$post_pm_l_img = '<a class="button_new pm" href="' . $post_pm . '" title="' . $lang['Post_new_pm'] . '"><div class="reg">' . $lang['New'] . '<span class="golden">' . $lang['Post'] . '</span></div></a>';
