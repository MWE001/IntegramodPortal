...
bbcode = new Array();
bbtags = new Array('[b]','[/b]','[i]','[/i]','[u]','[/u]','[quote]','[/quote]','[code]','[/code]','[list]','[/list]','[list=]','[/list]','[img]','[/img]','[url]','[/url]','[web]','[/web]','[web2]','[/web2]');
imageTag = false;
...
<table width="450" border="0" cellspacing="0" cellpadding="2">
		  ...
		  <tr align="center" valign="middle">
			<td><span class="genmed"> 
			  <input type="button" class="button" accesskey="y" name="addbbcode18" value="Web" style="text-decoration: underline; width: 44px" onClick="bbstyle(18)" onMouseOver="helpline('y')" />
			  </span></td>
			<td><span class="genmed"> 
			  <input type="button" class="button" accesskey="z" name="addbbcode20" value="Web2" style="text-decoration: underline; width: 48px" onClick="bbstyle(20)" onMouseOver="helpline('z')" />
			  </span></td>
		  </tr>
		  <tr> 
			<td colspan="9"> 
