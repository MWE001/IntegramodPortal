...
<!-- BEGIN blocks -->
<tr> 
<td nowrap="nowrap" class="{blocks.ROW_CLASS}" align="center"><a href="{blocks.U_MOVE_UP}"><img src="images/p_up.png" alt="{L_MOVE_UP}" title="{L_MOVE_UP}" width="30" height="30" /></a></td>
<td nowrap="nowrap" class="{blocks.ROW_CLASS}" align="center"><a href="{blocks.U_MOVE_DOWN}"><img src="images/p_down.png" alt="{L_MOVE_DOWN}" title="{L_MOVE_DOWN}" width="30" height="30" /></a></td>
<td nowrap="nowrap" class="{blocks.ROW_CLASS}" align="center"><a href="{blocks.U_EDIT}"><img src="images/p_edit.png" alt="{L_EDIT} {L_BLOCK}" title="{L_EDIT}" width="30" height="30" /></a></td>
<td nowrap="nowrap" class="{blocks.ROW_CLASS}" align="center"><a href="{blocks.U_DELETE}"><img src="images/p_delete.png" alt="{L_DELETE}" title="{L_DELETE}" width="30" height="30" /></a></td>
