      ...
      >
        ...
        <tr>
          ...
          >
            ...
            <div id="block1_{center_blocks_row.BLOCKID}" style="position:relative;" align="center">{center_blocks_row.OUTPUT}
...
//-->
    ...
    <td id="right_block" style="width:180px">
       				...
       				<!-- END title_image -->
         				...
         				<!-- END background -->
          				...
          				<div onclick="ShowHide('block1_{right_blocks_row.BLOCKID}','block2_{right_blocks_row.BLOCKID}','block1_{right_blocks_row.BLOCKID}');" style="display:none; width:100%; cursor: pointer; cursor: hand;" id="block2_{right_blocks_row.BLOCKID}" align="center"><img src="{right_blocks_row.openclose.OPEN_IMG}" /></div>
           				...
           				<div id="block1_{right_blocks_row.BLOCKID}" style="position: relative;">{right_blocks_row.OUTPUT}
               			<!-- BEGIN openclose -->
...
<!-- BEGIN layout_collapse -->
     <td id="right_hide" style="display:none;" valign="top" align="right" width="10" height="18">
	     <a href="javascript:ShowHide('right_block','right_hide','right_block');"><img src="{layout_collapse.LAYOUT_IMAGEL}" width="10" height="18" alt="" border="0" /></a>
     </td>
<!-- END layout_collapse -->
<!-- BEGIN no_layout_collapse -->
	<td width="10"><img src="images/spacer.gif" alt="" width="10" height="30" /></td>
