...
<form method="post" action="{S_POST_DAYS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	...
	<tr> 
	  <td align="left" valign="middle" nowrap="nowrap"><span class="nav"><a class="button_new" href="{U_POST_NEW_TOPIC}"  title="{L_POST_NEW_TOPIC}"><div class="reg">{L_NEW}<span class="golden">{L_TOPIC}</span></div></a></span></td>
