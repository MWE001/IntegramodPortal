...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
  <tr>
	  <td valign="middle">{REPLY_PM_L_IMG}</td>
...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  <td nowrap="nowrap" class="row2" align="right"> {QUOTE_PM_L_IMG} {EDIT_PM_L_IMG}</td>
	</tr>
	<tr> 
	...
	<tr> 
	  <td width="78%" height="28" valign="bottom" colspan="3" class="row1"> 
		<table cellspacing="0" cellpadding="0" border="0" height="18">
		  <tr> 
			<td valign="middle" nowrap="nowrap">{PROFILE_L_IMG} {PM_L_IMG} {EMAIL_L_IMG} 
			  {WWW_L_IMG} {AIM_L_IMG} {YIM_L_IMG} {MSN_L_IMG}</td><td>&nbsp;</td><td valign="top" nowrap="nowrap"><script language="JavaScript" type="text/javascript"><!-- 

		if ( navigator.userAgent.toLowerCase().indexOf('mozilla') != -1 && navigator.userAgent.indexOf('5.') == -1 && navigator.userAgent.indexOf('6.') == -1 )
			document.write('{ICQ_L_IMG}');
		else
			document.write('<div style="position:relative"><div style="position:absolute">{ICQ_L_IMG}</div><div style="position:absolute;left:9px;top:-1px">{ICQ_STATUS_IMG}</div></div>');
