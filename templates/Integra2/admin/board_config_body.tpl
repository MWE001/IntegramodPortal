...
<form action="{S_CONFIG_ACTION}" method="post"><table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<!-- Start phpBB Word Graph MOD by www.pentapenguin.com -->
	<tr>
	  <th class="thHead" colspan="2">{L_WORD_GRAPH}</th>
	</tr>
	
	<tr>
		<td class="row1">{L_WORD_GRAPH_MAX_WORDS}<br /><span class="gensmall">{L_WORD_GRAPH_MAX_WORDS_EXPLAIN}</span></td>
		<td class="row2"><input class="post" type="text" name="word_graph_max_words" value="{WORD_GRAPH_MAX_WORDS}" size="4" maxlength="4" /></td>
	</tr>
	<tr>
		<td class="row1">{L_WORD_GRAPH_WORD_COUNTS}<br /><span class="gensmall">{L_WORD_GRAPH_WORD_COUNTS_EXPLAIN}</span></td>
		<td class="row2"><input type="radio" name="word_graph_word_counts" value="1" {WORD_GRAPH_WORD_COUNTS_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="word_graph_word_counts" value="0" {WORD_GRAPH_WORD_COUNTS_NO} /> {L_NO}</td>
	</tr>
	<!-- Finish phpBB Word Graph MOD by www.pentapenguin.com -->
	<tr>
