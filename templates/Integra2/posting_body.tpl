	  ...
	  <td class="row2" valign="top"><span class="gen"> <span class="genmed"> </span> 
		<table width="450" border="0" cellspacing="0" cellpadding="2">
		  <tr align="center" valign="middle"> 
			...
			<td><span class="genmed"> 
			  <input type="button" class="button" accesskey="y" name="addbbcode18" value="Web" style="text-decoration: underline; width: 40px" onClick="bbstyle(18)" onMouseOver="helpline('y')" />
			  </span></td>
		  </tr>
		  <tr> 
			<td colspan="9"> 
