...
<!-- BEGIN web --><iframe width="100%" height="500" src="{URL}"></iframe><!-- END web -->

<!-- BEGIN web2 --><iframe width="100%" height="900" frameborder="0" seamless="seamless" src="{URL}"></iframe><!-- END web2 -->