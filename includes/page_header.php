 ...
 *
 *   $Id: page_header.php 8479 2008-03-29 00:22:48Z naderman $
 *
 *
 ***************************************************************************/
...
$admin_link2 = ( $userdata['user_level'] == ADMIN ) ? '<a href="admin/index.' . $phpEx . '?sid=' . $userdata['session_id'] . '&amp;p_sid=' . $userdata['priv_session_id'] . '" class="adminlink" title="' . $lang['Admin_panel'] . '">' . $lang['Admin_panel2'] . '</a>' : '';
$admin_bull = ( $userdata['user_level'] == ADMIN ) ?  $lang['Admin_bull']  : '';

$template->assign_vars(array(
	'ADMIN_LINK2' => $admin_link2,
	'ADMIN_BULL' => $admin_bull)
);
