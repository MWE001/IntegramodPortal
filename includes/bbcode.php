 ...
 *
 *   $Id: bbcode.php 8842 2008-09-11 13:52:22Z Kellanved $
 *
 ***************************************************************************/
...
function prepare_bbcode_template($bbcode_tpl)
{
	...
	$bbcode_tpl['web2'] = str_replace('{URL}', '\\1', $bbcode_tpl['web2']);
...
function bbencode_second_pass($text, $uid)
{
	...
	// [web2]Web Iframe URL[/web2] code..
	$patterns[] = "#\[web2:$uid\](.*?)\[/web2:$uid\]#si";
	$replacements[] = $bbcode_tpl['web2'];
...
function bbencode_first_pass($text, $uid)
{
	...
	// [web2]Web Iframe URL[/web2] code..
	$text = preg_replace("#\[web2\](http(s)?://)([a-z0-9\-\.,\?!%\*_\#:;~\\&$@\/=\+]+)\[/web2\]#si", "[web2:$uid]\\1\\3[/web2:$uid]", $text);
